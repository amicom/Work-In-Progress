...
import utils.net.httpconnection.SocksHTTPconnection;
...
public class Socks4SocketConnection extends SocketConnection {
    ...
    public static Socket establishConnection(final Socket proxySocket, final String userID, final SocketAddress endpoint, SocksHTTPconnection.DESTTYPE destType, final StringBuffer logger) throws IOException {
        ...
        switch (destType) {
            ...
            case DOMAIN:
                destType = SocksHTTPconnection.DESTTYPE.DOMAIN;
            /* we use domain */
                os.write((byte) 0);
                os.write((byte) 0);
                os.write((byte) 0);
        ...
        /* NULL/end */
        os.write((byte) 0);
        if (SocksHTTPconnection.DESTTYPE.DOMAIN.equals(destType)) {
