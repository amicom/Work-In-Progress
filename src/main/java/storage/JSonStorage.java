...
public class JSonStorage {
     ...
     *
     * @param <E>
     * @param string name of the json object. example: cfg/savedobject.json
     * @param type   TypeRef instance. This is important for generic classes. for example: new TypeRef<ArrayList<Contact>>(){} to restore type
     *               java.util.List<Contact>
     * @param def    defaultvalue. if typeref is not set, the method tries to use the class of def as restoreclass
     * @return
     */
