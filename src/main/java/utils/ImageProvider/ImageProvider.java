 ...
 * for details
 */
package utils.ImageProvider;

import storage.config.MinTimeWeakReference;
import storage.config.MinTimeWeakReferenceCleanup;
import sunwrapper.sun.awt.image.ToolkitImageWrapper;
...
public class ImageProvider {
    ...
    /**
     * @param name        to the png file
     * @param createDummy TODO
     * @return
     * @throws IOException
     */
