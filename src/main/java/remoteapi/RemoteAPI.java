...
public class RemoteAPI implements HttpRequestHandler {
    ...
    protected RemoteAPIRequest createRemoteAPIRequestObject(final HttpRequest request, final String method, final InterfaceHandler<?> interfaceHandler, final List<String> parameters, final String jqueryCallback) throws IOException, ApiCommandNotAvailable {
