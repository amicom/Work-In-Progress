...
public class SimpleThrottledConnectionHandler implements ThrottledConnectionHandler {
    ...
    public void addThrottledConnection(final ThrottledConnection con) {
        ...
        synchronized (this) {
            final List<ThrottledConnection> newConnections = new ArrayList<ThrottledConnection>(this.connections);
        ...
        synchronized (this.watchDogLOCK) {
            ...
            this.watchDog = new Thread() {
                ...
                public void run() {
                    ...
                    while (true) {
                        final List<ThrottledConnection> lConnections = SimpleThrottledConnectionHandler.this.connections;
