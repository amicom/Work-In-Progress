...
public class HTTPHeaderMap<V> implements Map<String, V> {
    ...
    public static void main(final String[] args) {
        ...
        final ArrayList<Entry<String, String>> retain = new ArrayList<Entry<String, String>>();
        while (it.hasNext()) {
            next = it.next();
    ...
    private Entry<String, V> convertFromEntry(final Entry<HTTPHeaderMapEntry, V> e) {
        final String key;
        if (e.getKey() == null) {
            key = null;
        } else {
        ...
        final Entry<String, V> entry = new Entry<String, V>() {
            V value = e.getValue();
    ...
    private Entry<HTTPHeaderMapEntry, V> convertToEntry(final Entry<String, V> e) {
        ...
        final Entry<HTTPHeaderMapEntry, V> entry = new Entry<HTTPHeaderMapEntry, V>() {
            V value = e.getValue();
