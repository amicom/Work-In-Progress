...
import controlling.State;
import controlling.StateConflictException;
import controlling.StateMachine;
import controlling.StateMachineInterface;
import utils.Regex;
            ...
            try {
                if (commandEnum != null) {
                    if (commandEnum.needLogin) {
                        ...
                        if (!this.stateMachine.isState(FtpConnection.LOGIN)) {
